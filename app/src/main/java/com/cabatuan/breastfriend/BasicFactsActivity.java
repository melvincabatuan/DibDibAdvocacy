 ...
 */
public class BasicFactsActivity extends AppCompatActivity implements TextToSpeech.OnInitListener{


    public final static String TAG = "BasicFactsActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_facts);

        // Extract String info array for slides
        infotext = getResources().getStringArray(R.array.basicsinfotext);
    ...
    public void initializePager(){
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                if (endPage>2) {
                    endPage = 0;
                    String message = getString(R.string.title_basic_facts) + " completed!";
                    showToast(message);
                    NavUtils.navigateUpTo(BasicFactsActivity.this, new Intent(BasicFactsActivity.this, MainActivity.class));
                }
            }
            ...
            private void showToast(String message) {
                ...
                // Set the image
                iv.setImageResource(R.mipmap.ic_facts);
    ...
    private class MyPagerAdapter extends PagerAdapter {
        ...
        int NumberOfPages = infotext.length;
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            TextView textView = new TextView(BasicFactsActivity.this);
            textView.setTextColor(getResources().getColor(R.color.pink));
            textView.setTextSize(24);
            textView.setGravity(Gravity.CENTER);
            textView.setText(String.valueOf(position + 1) + ". " + infotext[position]);

            ImageView imageView = new ImageView(BasicFactsActivity.this);
            imageView.setImageResource(res[position]);
            LayoutParams imageParams = new LayoutParams(
                    LayoutParams.MATCH_PARENT,LayoutParams.MATCH_PARENT);
            imageView.setLayoutParams(imageParams);

            LinearLayout layout = new LinearLayout(BasicFactsActivity.this);
