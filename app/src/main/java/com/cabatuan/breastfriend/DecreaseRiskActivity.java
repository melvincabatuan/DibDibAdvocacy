 ...
 */
public class DecreaseRiskActivity extends AppCompatActivity implements TextToSpeech.OnInitListener{


    public final static String TAG = "DecreaseRiskActivity";
    private ViewPager viewPager = null;
    private MyPagerAdapter myPagerAdapter = null;
    private TextToSpeech tts = null;
    private boolean ttsLoaded = false;
    private String[] infotext;
    private int endPage; // track viewpager end


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_decrease_risk);

        // Extract String info array for slides
        infotext = getResources().getStringArray(R.array.decreaseinfotext);
    ...
    public void initializePager(){
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                if (endPage>2) {
                    endPage = 0;
                    String message = getString(R.string.title_prevention) + " completed!";
                    showToast(message);
                    NavUtils.navigateUpTo(DecreaseRiskActivity.this, new Intent(DecreaseRiskActivity.this, MainActivity.class));
                }
            }
    ...
    private class MyPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            TextView textView = new TextView(DecreaseRiskActivity.this);
            textView.setTextColor(getResources().getColor(R.color.pink));
            textView.setTextSize(24);
            textView.setGravity(Gravity.CENTER);
            textView.setText(String.valueOf(position + 1) + ". " + infotext[position]);

            ImageView imageView = new ImageView(DecreaseRiskActivity.this);
            imageView.setImageResource(res[position]);
            ViewGroup.LayoutParams imageParams = new ViewGroup.LayoutParams(
                    ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
            imageView.setLayoutParams(imageParams);

            LinearLayout layout = new LinearLayout(DecreaseRiskActivity.this);
